      ...
      <div className={`transition-all duration-300 ease-in-out ${isSidebarOpen ? 'ml-72' : 'ml-20'} flex flex-col items-center justify-center min-h-screen`}>
        <div className="flex flex-col items-center -mt-32">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col items-center">
            <input type="file" onChange={handleFileChange} accept=".jpg,.jpeg,.png" className="mb-4" />
            <button
              type="submit"
              className="bg-[#669BBC] text-white px-8 py-2 rounded-md cursor-pointer hover:bg-opacity-90 transition-opacity mb-12 font-['Fira_Sans_Extra_Condensed']"
            >
              Submit
            </button>
          </form>
          ...
          {prediction && <p className="text-lg font-semibold text-[#1B4965]">Predicted Class: {prediction}</p>}
